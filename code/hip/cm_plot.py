...
@originalauthor: Wagner Cipriano - wagnerbhbr - gmail - CEFETMG / MMC
"""
...
def configcell_text_and_colors(
    ...
    if (col == (ccl - 1)) or (lin == (ccl - 1)):
        ...
        text_kwargs = dict(
            color="k", ha="center", va="center", gid="sum", fontproperties=font_prop
        )
...
def pretty_plot_confusion_matrix(
    ...
    df_cm = DataFrame(cm.astype(int), index=g, columns=g)
    ...
    ax.set_yticklabels(ax.get_yticklabels(), rotation=0, fontsize=fz)
